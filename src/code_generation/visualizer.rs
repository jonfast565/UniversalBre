...
impl GraphvizFormatter {
    ...
    pub fn build_binary_node(node: &String, label: &String, first_edges: &String, second_edges: &String) -> String {
        format!("{}\n{}\n{}", GraphvizFormatter::build_node_label(node, label), first_edges, second_edges)
    }
